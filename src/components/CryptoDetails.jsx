...
const CryptoDetails = () => {
  ...
  const {data, isFetching} = useGetCryptoDetailsQuery(currencyUuid);
  const {data: coinHistory} = useGetCryptoHistoryQuery({currencyUuid, timePeriod});
        ...
        <Col className='coin-desc-link'>
          <Row className='coin-desc'>
              <Title level={3} className="coin-details-heading">
                  ...
                  {/* Htmlreactparse coverts plain html to working html */}
